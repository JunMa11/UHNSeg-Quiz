...
nnUNet_raw='/scratch/ssd004/datasets/med-img-data/nnunet_data/nnUNet_raw' # os.environ.get('nnUNet_raw')
nnUNet_preprocessed='/scratch/ssd004/datasets/med-img-data/nnunet_data/nnUNet_preprocessed' # os.environ.get('nnUNet_preprocessed')
nnUNet_results='/scratch/ssd004/datasets/med-img-data/nnunet_data/nnUNet_results' # os.environ.get('nnUNet_results')
